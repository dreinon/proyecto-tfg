...
Delivery surface: the compiled thesis PDF, in the Results chapter. Renderer: Matplotlib, static
300 dpi PNG; four directly labelled columns per row, a white background, dark text and quiet grey
...
manifest. They are not claimed as a newly preregistered sample, a new human review, or a frequency
...
Verified locally on 7 September 2026: all 21 input/output and thesis-copy hashes reconcile;
